    ...
    <>
      ...
      <div id="spaces-page" className="position-relative">
        <section className="position-relative">
          <div className="container">
            <div className="row">
              {spacesData.map((space, index) => (
                <div key={index} className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 spaces-content-outer mb-4">
                  <div className="spaces-img-outer-box">
                    <div className="spaces-image-box">
                      <img src={space.image} className="space-image" alt={space.title} />
                    </div>
                  </div>
          ...
          <div className="spaces-bg-clor" style={{ backgroundSize: "100% 100%", backgroundRepeat: "no-repeat", backgroundPosition: "bottom" }}></div>
        </section>
      </div>
    </>
  );
