export function IconOverview({ className }) {
  return (
    <svg className={className} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 4h7v7H4V4zm9 0h7v5h-7V4zM4 13h7v7H4v-7zm9 3h7v4h-7v-4z" />
    </svg>
  );
}

export function IconLeads({ className }) {
  return (
    <svg className={className} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
...
export function IconBlogs({ className }) {
  return (
    <svg className={className} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
...
export function IconQuotes({ className }) {
  return (
    <svg className={className} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
      <path strokeLinecap="round" strokeLinejoin="round" d="M8 12H4a2 2 0 01-2-2V7a3 3 0 013-3h1v4a2 2 0 002 2zm12 0h-4a2 2 0 01-2-2V7a3 3 0 013-3h1v4a2 2 0 002 2z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 12v2a6 6 0 006 6M16 12v2a6 6 0 006 6" />
    </svg>
  );
}
...
export function IconGrowth({ className }) {
  return (
    <svg className={className} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M16 8l3-3 3 3" />
    </svg>
  );
}
