...
export const SEED_BLOG_POSTS: BlogPost[] = [
  post({
    ...
    cover_image_url: "/assets/blog1.jpg",
    cover_image_alt: "Open coworking floor at NeoHub Gomti Nagar Lucknow",
    author: "NeoHub Team",
...
`.trim(),
  ...
  post({
    ...
    cover_image_url: "/assets/space-private.jpg",
    cover_image_alt: "Private cabin and dedicated workstations comparison at NeoHub",
    author: "NeoHub Team",
...
`.trim(),
  ...
  post({
    ...
    cover_image_url: "/assets/space-desk.jpg",
    cover_image_alt: "Pricing guide for coworking desks and cabins in Lucknow",
    author: "NeoHub Team",
...
`.trim(),
  ...
  post({
    ...
    cover_image_url: "/assets/blog2.jpg",
    cover_image_alt: "Startup team working in a Lucknow coworking space",
    author: "NeoHub Team",
...
`.trim(),
  ...
  post({
    ...
    cover_image_url: "/assets/space-conf.jpg",
    cover_image_alt: "Conference room ready for client meetings in Gomti Nagar",
    author: "NeoHub Team",
