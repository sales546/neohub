...
/**
 * Verified NeoHub coworking centres in Lucknow.
 * Operator NAP (do not render as on-page instructions): brand NeoHub Coworking Space,
 * phone +91 70004 81286 only, email contact@neohubspaces.in, one listing per building.
 */
...
export const neoHubAddresses = [
  ...
  },
  {
    ...
    phoneTel: "+917000481286",
    hours: "Open 24 hours",
    pagePath: "/bhavya-corporate-tower",
    googleMapsUrl:
      "https://www.google.com/maps/place/NEOHUB+-+Bhavya+Tower/@26.8661776,80.9969169,17z/data=!3m1!4b1!4m6!3m5!1s0x399be3f5fe2ec023:0xa994cce33170b957!8m2!3d26.8661776!4d80.9969169",
    mapEmbedUrl:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7118.350186674988!2d80.99691699357909!3d26.866177600000018!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399be3f5fe2ec023%3A0xa994cce33170b957!2sNEOHUB%20-%20Bhavya%20Tower!5e0!3m2!1sen!2sin!4v1755697317962!5m2!1sen!2sin",
  ...
  },
  {
    ...
    rating: null,
    address:
      "6th Floor, Experion, 611, Vibhuti Khand, Gomti Nagar, Lucknow, Uttar Pradesh 226010",
    phone: "+91 70004 81286",
    phoneTel: "+917000481286",
    hours: "9 am–10 pm",
    pagePath: "/experion",
    googleMapsUrl:
      "https://www.google.com/maps/place/Neohub+Coworking-+Experion/@26.868378,81.0119404,17z/data=!3m1!4b1!4m6!3m5!1s0x399be3c9dd253683:0x3da1a057fd5d8adc!8m2!3d26.868378!4d81.0119404",
    mapEmbedUrl:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3558.0!2d81.0119404!3d26.868378!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399be3c9dd253683%3A0x3da1a057fd5d8adc!2sNeohub%20Coworking-%20Experion!5e0!3m2!1sen!2sin!4v1755698000000!5m2!1sen!2sin",
    pricing: {
      workstation: "6,500",
      cabin: "25,000",
      conference: "600",
...
export const trustStats = [
  { value: "1000", suffix: "+", label: "Seats Across Spaces" },
...
export const aboutHighlights = [
  ...
  { value: "1000", suffix: "+", label: "Seats across locations" },
];
...
export const pricingPlans = [
  {
    ...
    tag: "",
    unit: "/month + GST",
    desc: "Lockable private cabins for teams. From ₹20,000/cabin/mo at Cyber Heights & Bhavya; ₹25,000/cabin/mo at Experion (+ GST). Typical cabins hold 4–8 seats.",
  },
  {
    slug: "dedicated-desk",
...
/** Clients featured on the homepage partners strip (logo + readable name). */
export const partnerLogos = [
  {
    src: "/assets/clients/tata-communications.png",
    alt: "Tata Communications Transformation Services",
    name: "Tata Communications",
    initials: "TC",
  },
  {
    src: "/assets/clients/indiamart.png",
    alt: "IndiaMART",
    name: "IndiaMART",
    initials: "IM",
  },
  {
    src: "/assets/clients/sterlite.png",
    alt: "Sterlite Technologies",
  ...
  {
    src: "/assets/clients/tata-play.png",
    alt: "Tata Play",
    name: "Tata Play",
    initials: "TP",
  },
  {
    src: "/assets/clients/zomato.png",
    alt: "Zomato (Eternal)",
    name: "Zomato",
    initials: "ZO",
  },
  {
    src: "/assets/clients/woodrock.png",
    alt: "WoodRock",
    name: "WoodRock",
    initials: "WR",
  },
  {
    src: "/assets/clients/oyo.png",
    alt: "OYO",
    name: "OYO",
    initials: "OYO",
  },
  {
    src: "/assets/clients/dss.png",
    alt: "DSS",
    name: "DSS",
    initials: "DSS",
  },
  {
    src: "/assets/clients/ceragon.png",
    alt: "Ceragon",
    name: "Ceragon",
    initials: "CG",
  },
  {
    src: "/assets/clients/cars24.png",
    alt: "Cars24",
    name: "Cars24",
    initials: "C24",
  },
  {
    src: "/assets/clients/eclat.png",
    alt: "Eclat Health Solutions",
    name: "Eclat Health Solutions",
    initials: "EH",
  },
  {
    src: "/assets/clients/excelon.png",
    alt: "Excelon Solutions",
    name: "Excelon Solutions",
    initials: "EX",
  },
];

/** Full client roster from NeoHub operations notes. */
export const clientNames = partnerLogos.map((logo) => logo.alt);
export const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    text: "NeoHub feels premium without the corporate stiffness — great for client meetings, focused workdays, and growing the team under one roof.",
  },
];
...
/** Hub links for older articles that sit below the blog grid's first page. */
export const workspaceGuideLinks = [
  {
    href: "/blog/coworking-space-pricing-lucknow-2026",
    label: "Coworking pricing in Lucknow (2026)",
  },
  {
    href: "/blog/why-startups-choose-coworking-over-traditional-offices-lucknow",
    label: "Why startups choose coworking",
  },
  {
...
export const blogPreviews = [
  {
    ...
    image: "/assets/blog-covers/neohub-gomti-nagar-hub.webp",
    date: "18",
    month: "Jul",
  ...
  },
  {
    ...
    image: "/assets/blog-covers/neohub-private-cabin.webp",
    date: "15",
    month: "Jul",
  ...
  {
    href: "/blog/coworking-space-pricing-lucknow-2026",
    image: "/assets/blog-covers/neohub-workstations.webp",
    date: "12",
    month: "Jul",
...
export const homeGalleryImages = [
  { src: "/assets/galleryimg1_3b163f91.webp", alt: "NeoHub coworking lounge at Levana Cyber Heights" },
  { src: "/assets/galleryimg2_cf31ca9e.webp", alt: "Open coworking area with natural light" },
  { src: "/assets/galleryimg3_d90d3227.webp", alt: "Professional meeting room setup" },
  { src: "/assets/galleryimg4_426fab93.webp", alt: "Private cabin workspace for teams" },
  { src: "/assets/galleryimg5_5319e1bc.webp", alt: "Conference room with AV equipment" },
];

export const galleryImages = [
  { src: "/assets/galleryimg1_3b163f91.webp", alt: "Lounge seating at NeoHub coworking in Gomti Nagar, Lucknow" },
  { src: "/assets/galleryimg2_cf31ca9e.webp", alt: "Open-plan coworking floor with natural light at NeoHub" },
  { src: "/assets/galleryimg3_d90d3227.webp", alt: "Meeting room with table, chairs, and presentation screen" },
  { src: "/assets/galleryimg4_426fab93.webp", alt: "Lockable private cabin for a small team at NeoHub" },
  { src: "/assets/galleryimg5_5319e1bc.webp", alt: "Conference room with AV setup at NeoHub Lucknow" },
  { src: "/assets/galleryimg6_41584ce5.webp", alt: "Breakout lounge and informal seating at NeoHub" },
  { src: "/assets/galleryimg7_ffa21c49.webp", alt: "Dedicated workstations with ergonomic chairs at NeoHub" },
  { src: "/assets/galleryimg8_6c48ff7a.webp", alt: "Interior corridor and reception area at a NeoHub centre" },
  { src: "/assets/galleryimg9_ff9b2219.webp", alt: "Hot-desk seating in the shared coworking area" },
  { src: "/assets/galleryimg10_b69e6146.webp", alt: "Furnished private office interior at NeoHub Gomti Nagar" },
];
